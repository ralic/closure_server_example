...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22956__auto__,writer__22957__auto__,opt__22958__auto__){
return cljs.core._write.call(null,writer__22957__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__24092 = o;
(G__24092[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__24093__delegate = function (args){
...
while (G__24094__i < G__24094__a.length) {G__24094__a[G__24094__i] = arguments[G__24094__i + 0]; ++G__24094__i;}
  args = new cljs.core.IndexedSeq(G__24094__a,0);
} 
return G__24093__delegate.call(this,args);};
...
return G__24093__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__22333__auto__ = !((jsprops == null));
if(and__22333__auto__){
var and__22333__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__24100 = jsprops;
(G__24100["defaultValue"] = value);

(G__24100["onChange"] = ((function (G__24100,v,value,on_change){
return (function (p1__24098_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24098_SHARP_);
});})(G__24100,v,value,on_change))
);
...
var vec__24107 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24107,(0),null);
var id = cljs.core.nth.call(null,vec__24107,(1),null);
var class$ = cljs.core.nth.call(null,vec__24107,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___24112 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___24112 == null)){
} else {
var key_24113 = temp__4661__auto___24112;
(jsprops["key"] = key_24113);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24115 = (new reagent.impl.template.NativeWrapper());
(G__24115["name"] = c);
...
var len__23458__auto___24121 = arguments.length;
var i__23459__auto___24122 = (0);
while(true){
if((i__23459__auto___24122 < len__23458__auto___24121)){
args__23465__auto__.push((arguments[i__23459__auto___24122]));

var G__24123 = (i__23459__auto___24122 + (1));
i__23459__auto___24122 = G__24123;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__23466__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24119){
var G__24120 = cljs.core.first.call(null,seq24119);
var seq24119__$1 = cljs.core.next.call(null,seq24119);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__24120,seq24119__$1);
});
...
break;
default:
var G__24127 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24127;
continue;
...
var n__23268__auto___24130 = a.length;
var i_24131 = (0);
while(true){
if((i_24131 < n__23268__auto___24130)){
(a[i_24131] = reagent.impl.template.as_element.call(null,(a[i_24131])));
...
var a = cljs.core.into_array.call(null,s);
var n__23268__auto___24133 = a.length;
var i_24134 = (0);
while(true){
if((i_24134 < n__23268__auto___24133)){
var val_24135 = (a[i_24134]);
if((cljs.core.vector_QMARK_.call(null,val_24135)) && ((reagent.impl.template.key_from_vec.call(null,val_24135) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24134] = reagent.impl.template.as_element.call(null,val_24135));

var G__24136 = (i_24134 + (1));
i_24134 = G__24136;
continue;
} else {
}
...
var ctx = ({});
var vec__24140 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24140,(0),null);
var derefed = cljs.core.nth.call(null,vec__24140,(1),null);
...
var G__24144 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24144) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24144){
